...
export const EmbedChainInfos: ChainInfo[] = [
  ...
  // {
  //   rpc: CANARY_RPC_ENDPOINT,
  //   rpcConfig: CANARY_RPC_CONFIG,
  //   rest: CANARY_REST_ENDPOINT,
  //   restConfig: CANARY_REST_CONFIG,
  //   chainId: "imv",
  //   chainName: "CANARY Hub",
  //   stakeCurrency: {
  //     coinDenom: "NIMV",
  //     coinMinimalDenom: "nimv",
  //     coinDecimals: 6,
  //     coinGeckoId: "imv",
  //   },
  //   walletUrl: "https://query-endpoint-canary.imversed.com/",
  //   walletUrlForStaking: "https://query-endpoint-canary.imversed.com/",
  //   bip44: {
  //     coinType: 118,
  //   },
  //   bech32Config: Bech32Address.defaultBech32Config("imv"),
